...
from src.mcp_server.skeleton.convolution_block.convolution_module import ConvolutionLayerModule
from src.mcp_server.skeleton.convolution_block.refine_module import SelfRefineModule
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(os.path.join(log_dir, 'skeleton_refine_server.log'), encoding='utf-8'),
...
async def list_resources() -> List[Resource]:
    return [
        Resource(
            ...
            description="Prompt templates for modifying survey outlines",
...
async def list_tools() -> List[Tool]:
    return [
        Tool(
            ...
            description="Survey outline modification",
            inputSchema={
                "type": "object",
                "properties": {
                    "survey": {
                        "type": "object",
                        "description": "The survey object to be processed. The function of this tool is to modify the skeleton in the survey object",
                    },
                    "config": {"type": "object", "description": "Model configuration parameters required for generating abstracts"},
                    "convolution_layer": {"type": "object", "description": "The number of iterations when summarizing reference information using a convolution-like method"},
                    "convolution_kernel_size": {"type":"object", "description": "The number of references processed in a single batch when summarizing reference information using a convolution-like method"},
                    "convolution_result_num": {"type":"object", "description": "The number of results when summarizing reference information using a convolution-like method"},
                    "top_k": {"type": "object","description": "The number of final selected results when summarizing reference information using a convolution-like method"},
                    "self_refine_count": {"type": "object", "description": "The number of rounds of self-modification after the outline is generated"},
                    "self_refine_best_of": {"type": "object", "description": "The number of result samples for self-correction after the outline is generated"},
                },
