...
"""
SEARCH_USER_PROMPT="""如果查询包含宽泛或模糊的概念，请将它们分解为更具体的子概念，以实现更精确的搜索。例如，“外国”可以进一步分解为在报告领域内具有代表性的特定国家或地区。仅以简单字符串的形式返回由[]引用的查询，用逗号分隔。例如：“[query_1，query_2，…，query_n]”。
"""
